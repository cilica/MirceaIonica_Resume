...
\begin{itemize}
  ...
  \item
	...
	\begin{itemize*}
        ...
        \item Involved in requirements elicitation and documentation for ADAS related system
		\item Coordinating a cross-functional Agile Team
		\item Making architectural decisions and creating decompositions and views for ADAS related SW (Classic AUTOSAR)
	\end{itemize*}
